...
mout <- readRDS("./output/mca/updog_fits_non.RDS")
...
saveRDS(object = ld_comp_genolike, file = "./output/mca/ldest_comp_genolike_non.RDS")
...
saveRDS(object = ld_comp_genolike_flex, file = "./output/mca/ldest_comp_genolike_flex_non.RDS")
...
saveRDS(object = ld_comp_geno, file = "./output/mca/ldest_comp_geno_non.RDS")
